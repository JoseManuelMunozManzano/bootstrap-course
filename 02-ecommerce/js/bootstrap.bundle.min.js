...
!(function (t, e) {
  ...
  const t = 'transitionend',
    ...
    s = (t) =>
      n(t) ? (t.jquery ? t[0] : t) : 'string' == typeof t && t.length > 0 ? document.querySelector(e(t)) : null,
    o = (t) => {
        ...
        ? (function (t, e, i) {
            return function n(s) {
              ...
              for (let { target: r } = s; r && r !== this; r = r.parentNode)
                for (const a of o)
                  if (a === r) return N(s, { delegateTarget: r }), n.oneOff && I.off(t, s.type, e, i), i.apply(r, [s]);
            };
          })(t, i, r)
        : (function (t, e) {
            return function i(n) {
